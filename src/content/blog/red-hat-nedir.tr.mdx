...
2. **[RHEL kurulumu](/blog/rhel-kurulumu).** Ücretsiz geliştirici aboneliği, sanal makine, kurulum adım adım.
...
- Sırada: bir Red Hat hesabı açmak, ücretsiz aboneliği almak ve RHEL'i bilgisayarımızdaki bir sanal makineye
  adım adım kurmak: [Bölüm 2, RHEL Kurulumu](/blog/rhel-kurulumu).
</Callout>
